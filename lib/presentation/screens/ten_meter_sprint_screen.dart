...
class TenMeterSprintScreen extends StatefulWidget {
  const TenMeterSprintScreen({super.key});

  @override
  State<TenMeterSprintScreen> createState() => _TenMeterSprintScreenState();
}

class _TenMeterSprintScreenState extends State<TenMeterSprintScreen> {
  ...
  void _showMeasurementDialog(AthleteModel athlete) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(
          '${athlete.name} ${athlete.surname} - 10m Sprint',
            ...
            children: [
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Kısa mesafede maksimum hızlanma testi',
                      style: TextStyle(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      '${athlete.gender == "Erkek" ? "Mükemmel <1.6s, İyi 1.6-1.8s, Orta 1.8-2.0s" : "Mükemmel <1.8s, İyi 1.8-2.0s, Orta 2.0-2.2s"}',
                      style: TextStyle(
                        fontSize: 11,
  ...
  String _getPerformanceLevel(double time, String gender) {
    if (gender == "Erkek") {
      if (time < 1.6) return "Mükemmel";
      if (time <= 1.8) return "İyi";
      if (time <= 2.0) return "Orta";
      return "Zayıf";
    } else {
      if (time < 1.8) return "Mükemmel";
      if (time <= 2.0) return "İyi";
      if (time <= 2.2) return "Orta";
      return "Zayıf";
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('10m Sprint Test'),
        backgroundColor: AppTheme.primaryColor,
        foregroundColor: AppTheme.whiteTextColor,
        elevation: 2,
      ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            '3. 10 metreyi en kısa sürede koş\n'
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'Önemli: Maksimum hızlanma + Düz çizgi takibi',
                                    style: TextStyle(
                                      fontSize: 12,
                                      color: AppTheme.secondaryColor,
                                      fontWeight: FontWeight.w600,
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '• Futbol - ilk adım hızı\n'
                                  '• Atletizm - sprint başlangıcı\n'
                                  '• Basketbol - hızlı hücum\n'
                                  '• Patlayıcı hız ve reaksiyon ölçümü',
                                  style: TextStyle(
                                    fontSize: 11,
                                    color: AppTheme.primaryTextColor,
                                    height: 1.3,
