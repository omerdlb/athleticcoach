...
class ShoulderFlexibilityTestScreen extends StatefulWidget {
  const ShoulderFlexibilityTestScreen({super.key});

  @override
  State<ShoulderFlexibilityTestScreen> createState() => _ShoulderFlexibilityTestScreenState();
}

class _ShoulderFlexibilityTestScreenState extends State<ShoulderFlexibilityTestScreen> {
  ...
  void _showMeasurementDialog(AthleteModel athlete) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(
          '${athlete.name} ${athlete.surname} - Shoulder Flexibility',
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Eller Arası Mesafe (cm)',
                  hintText: 'Örn: 25.5 (daha kısa = daha iyi)',
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Shoulder Flexibility Norm Değerleri:',
                      style: TextStyle(
                        fontSize: 12,
                    ...
                    Text(
                      ...
                      '${athlete.gender == "Erkek" ? "Mükemmel <20cm, İyi 20-30cm, Orta 30-40cm" : "Mükemmel <15cm, İyi 15-25cm, Orta 25-35cm"}',
                      style: TextStyle(
                        fontSize: 11,
  ...
  String _getPerformanceLevel(double distance, String gender) {
    if (gender == "Erkek") {
      if (distance < 20) return "Mükemmel";
      if (distance <= 30) return "İyi";
      if (distance <= 40) return "Orta";
      return "Zayıf";
    } else {
      if (distance < 15) return "Mükemmel";
      if (distance <= 25) return "İyi";
      if (distance <= 35) return "Orta";
      return "Zayıf";
    }
  }
  ...
  Future<void> _saveResult(AthleteModel athlete, double distance, String notes) async {
    try {
      ...
      final result = TestResultModel(
        ...
        testId: 'shoulder-flex',
        testName: 'Shoulder Flexibility Test',
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('${athlete.name} ${athlete.surname} - ${distance}cm ($performanceLevel)'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Shoulder Flexibility Test'),
        backgroundColor: AppTheme.primaryColor,
        foregroundColor: AppTheme.whiteTextColor,
        elevation: 2,
      ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            '2. Çubuğu iki el ile tutar\n'
                            '3. Kollar düz, çubuk baş üzerinden arkaya doğru götürülür\n'
                            '4. Eller arası mesafe ölçülür\n'
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'Önemli: Kollar düz + Çubuk baş üzerinden',
                                    style: TextStyle(
                                      fontSize: 12,
                                      color: AppTheme.secondaryColor,
                                      fontWeight: FontWeight.w600,
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '• Yüzme - omuz hareket kabiliyeti\n'
                                  '• Jimnastik - esneklik değerlendirme\n'
                                  '• Tenis - servis hareketi\n'
                                  '• Genel fitness - omuz esnekliği',
                                  style: TextStyle(
                                    fontSize: 11,
                                    color: AppTheme.primaryTextColor,
                                    height: 1.3,
